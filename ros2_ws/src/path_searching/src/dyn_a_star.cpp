...
// ROS2 PORT: rclcpp logging replaces ROS_* macros
...
bool AStar::ConvertToIndexAndAdjustStartEndPoints(Vector3d start_pt, Vector3d end_pt, Vector3i &start_idx, Vector3i &end_idx)
{
    ...
    {
        //RCLCPP_WARN(logger_, "Start point is insdide an obstacle.");
        do
        {
    ...
    {
        //RCLCPP_WARN(logger_, "End point is insdide an obstacle.");
        do
        {
...
bool AStar::AstarSearch(const double step_size, Vector3d start_pt, Vector3d end_pt)
{
    ...
    {
        RCLCPP_ERROR(logger_, "Unable to handle the initial or end point, force return!");
        return false;
    }
    ...
    while (!openSet_.empty())
    {
        ...
        if (current->index(0) == endPtr->index(0) && current->index(1) == endPtr->index(1) && current->index(2) == endPtr->index(2))
        {
            ...
            //     RCLCPP_WARN(logger_, "Time consume in A star path finding is %f", (time_2 - time_1).toSec() );
        ...
        {
            RCLCPP_WARN(logger_, "Failed in A star path searching !!! 0.2 seconds time limit exceeded.");
            return false;
        }
    }
    ...
    if ((time_2 - time_1).toSec() > 0.1)
        RCLCPP_WARN(logger_, "Time consume in A star path finding is %.3fs, iter=%d", (time_2 - time_1).toSec(), num_iter);
