...
namespace ego_planner
{
  ...
  {
    node = nh;
    goal_point_pub = node->create_publisher<visualization_msgs::Marker>("goal_point", 2);
    global_list_pub = node->create_publisher<visualization_msgs::Marker>("global_list", 2);
    init_list_pub = node->create_publisher<visualization_msgs::Marker>("init_list", 2);
    optimal_list_pub = node->create_publisher<visualization_msgs::Marker>("optimal_list", 2);
    a_star_list_pub = node->create_publisher<visualization_msgs::Marker>("a_star_list", 20);
  }

  // // real ids used: {id, id+1000}
  void PlanningVisualization::displayMarkerList(rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr &pub, const vector<Eigen::Vector3d> &list, double scale,
